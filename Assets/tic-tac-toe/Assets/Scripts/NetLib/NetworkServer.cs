...
{
    private readonly NetworkClientCollection _clients =
                               new NetworkClientCollection();
                                 ...
                                 MessageReceivedEventArgs e)
    {
        ...
        PayloadReceived?.Invoke(sender,
                         new PayloadEventArgs<T>(payload));
    }
    ...
    protected virtual void OnClientConnected(NetworkClient
                                               networkClient)
    {
